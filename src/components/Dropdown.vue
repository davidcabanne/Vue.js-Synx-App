      ...
      <ul class="header__navbar">
        <li class="header__item">
          <transition name="slide-fade">
            ...
            <button class="header--button" key="on" @mouseenter="show = true">
              <div class="nav__profilePicture--cta">
                <img
                  class="nav__profilePicture"
                  src="https://static.ra.co/images/news/2018/project_pablo_album_canada_verdicchio.jpg"
                />
              </div>
            </button>
          </transition>
              ...
              <ul class="dropdown__menu-nav">
                <li class="dropdown__menu-item">
                  <a href="#" class="dropdown__menu-link" title="Account">
                    ...
                    <svg
                      class="dropdown__menu--arrow"
                      xmlns="http://www.w3.org/2000/svg"
                      width="3.0336mm"
                      height="6.1173mm"
                      viewBox="0 0 8.5991 17.3403"
                    >
                      <path
                        class="cls-1"
                        d="M.75,17.34a.75.75,0,0,1-.53-1.28L6.74,9.54A1.2313,1.2313,0,0,0,6.74,7.8L.22,1.28A.75.75,0,0,1,1.28.22L7.8008,6.74a2.7325,2.7325,0,0,1,0,3.86L1.28,17.1206A.7476.7476,0,0,1,.75,17.34Z"
                      />
                    </svg>
                  </a>
                </li>
...
.dropdown__menu {
  ...
  overflow-y: auto;
  padding-top: var(--spaceSml);
  padding-bottom: var(--spaceSml);
  border-radius: 12px;
...
.dropdown__menu-link {
  ...
  color: var(--ctaGrey);
  padding: var(--spaceSml) var(--spaceMed) var(--spaceSml) var(--spaceMed);
  margin-top: 5px;
  margin-bottom: 5px;
...
.dropdown__menu-link:hover > .dropdown__menu--arrow {
  opacity: 1;
  transform: translateX(0px);
}
.dropdown__menu-link:hover > .dropdown__menu-svg {
  color: var(--dark);
}
...
.active {
  opacity: 1;
  animation: fadeIn 0.2s cubic-bezier(0.77, 0, 0.18, 1);
}
...
.nav__profilePicture--notActive {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
  height: 100%;
  animation: picture_blends_out 1s ease-in-out;
}

.nav__profilePicture--isActive {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
  ...
  animation: picture_blends_in 0.2s ease-in-out forwards;
}

@keyframes picture_blends_in {
  0% {
    opacity: 0;
  }
  100% {
